...
`,[_t(),m("dropdown-option",`
 ...
 display: flex;
 position: relative;
 `),k("mask-hidden","pointer-events: none;",[S("> *",`
 pointer-events: all;
 `)])]),m("modal",`
 position: relative;
 align-self: center;
