...
let menus: Menu[] = [
  ...
  { id: 2, pid: 1, path: '/tools/calendar', name: 'calendar', menuType: 0, externalLink: 0, component: 'views/tools/calendar.vue', title: '日历', visibily: 1, icon: 'material-symbols:preview', keepAlive: 0, sort: 2 },
