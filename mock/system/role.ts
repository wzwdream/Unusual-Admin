...
const adminRole = ['/tools', '/tools/email', '/link', '/link/juejing', '/system', '/system/userRole', '/system/user', '/system/userMenu', '/system/dict', '/component', '/component/baseList', '/component/markdownDemo', '/component/richTextDemo', '/component/draggableDrid']
